...
class SentSplitter(Splitter):
    ...
    def __init__(self, pattern=DELIMITER, window=10):
        print('SentSplitter delimeters:', DELIMITER)
        # ([=:;]-?[)(]{1,3}|[\.\?!…;"„'»”’\)\]\}])
...
class SentSegmenter(Segmenter):
    # constructor
    # split default value - SentSplitter functor
    # rules default value - RULES
